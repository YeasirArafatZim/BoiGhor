...
<div class="row" style="padding:10px 0px 10px 0px;">
	...
	<div class="col-md-9">
		<div class="row" style="padding:0px 0px 10px 0px;">
			...
			<div class="col-md-12">
				<div style=" background-color:#FF0000; border-radius:6px 6px 0px 0px; color:#FFFFFF; font-size:20px; padding:8px 0px 8px 10px;">
					Searching Products
				</div>
			</div>
			...
			<div class="col-md-3" style="padding-top:30px;">
				<div class="col-md-12" style="border:solid 1px #FF0000; padding-bottom:10px;">
					...
					<div class="row" style="padding-left:5px; padding-right:5px;">
						<div style="color:##666666; font-size:12px; text-align:justify; padding-bottom:10px; padding-top:10px;">
						<?php echo $name; ?>
						</div>
						<div>
							<div class="col-md-6">
