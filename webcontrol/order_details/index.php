...
<body style="background-color:#FFFFFF;">
	<div class="row" style="width:100%; padding-bottom:20px;">
		...
		<div class="col-md-10">
			...
			<strong style="font-size:20px;">Order Details</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Control panel</span>
			</div>
			...
			<?php
				...
				$abc = mysql_query("select payment_type from payment_process where uniq_id = '$uniq_id'");
				$r = mysql_fetch_array($abc);
				...
				<div class="row" style="border-bottom:solid 1px #CCCCCC;">
					...
					<div class="col-md-2">
					<div class="row">
					<?php  if($r['payment_type']==1) echo Points;
					else echo Bkash ?>
					</div>
					</div>
	...
	<script src="ajax_file/ajax.js"></script>
