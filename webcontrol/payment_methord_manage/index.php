...
<body style="background-color:#FFFFFF;">
	<div class="row" style="width:100%; padding-bottom:20px;">
		...
		<div class="col-md-10">
			...
			<strong style="font-size:20px;">Payment Method Manage</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Control panel</span>
			</div>
			<div class="row" style="padding-bottom:30px;">
				...
				<form method="post" action="insert_action.php" enctype="multipart/form-data">
			...
			<?php
				$sn = 1;
				$p1= mysql_query ("select * from payment_methord order by id asc");
				while($q1=mysql_fetch_array($p1))
				{
				$id 					= $q1['id'];
				$description 			= htmlspecialchars_decode($q1['description'], ENT_QUOTES);
				$description_word		= substr($description, 0, 240);
			?>
